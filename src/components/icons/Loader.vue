...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" :width="size" :height="size" fill="none">
    ...
    <circle transform-origin="center" fill="none" stroke="url(#a10)" stroke-width="13" stroke-linecap="round"
    ...
    <circle transform-origin="center" fill="none" opacity=".2" stroke="#FFFFFF" stroke-width="13" stroke-linecap="round"
